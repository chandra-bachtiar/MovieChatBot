...
const Footer = ({ handleInputChange, inputData, handleClick, inputRef }) => {
    // console.log(inputData);
    return (
        <div className='w-full h-[10%] flex-none bg-[#f5f5f5] rounded-b-xl p-2'>
            <div className="flex h-full w-full gap-2">
                <div className="grow w-full h-full">
                    <input type="text" ref={inputRef} placeholder="Ketik Disini . . ." className="input w-full h-[90%]" value={inputData} onChange={handleInputChange} />
                </div>
